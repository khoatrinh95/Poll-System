...
<div style="border: 1px solid lightgray; border-radius: 30px; padding: 20px 50px 50px 50px;  width: fit-content; margin: 10% auto 0px auto; ">
    ...
    <h1 id="created" style="text-align: center; color: black; padding: 10px;">Forgot Password</h1>
    ...
    <form  action="umanager" method="POST">
        ...
        <input class="btn btn-primary" id = "signup" type="submit" name= "submit" value="Send email">
        <%
