...
<h1 id="created" style="text-align: center; color: black; padding: 10px;">Email Verification</h1>

<br>
<p>An email has been sent to <%=request.getAttribute("email")%>. </p>
<p>Please click on the link provided to verify your email.</p>
