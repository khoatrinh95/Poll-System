...
<div style="border: 1px solid lightgray; border-radius: 30px; padding: 20px 50px 50px 50px;  width: fit-content; margin: 10% auto 0px auto; ">
    ...
    <h1 id="created" style="text-align: center; color: black; padding: 10px;">Change Password</h1>
    ...
    <form  action="umanager" method="POST">
        <div>
            ...
            <input type="password" id="old_password" required class="form-control" placeholder="Old password" name="oldpassword">
        ...
        <input disabled class="btn btn-primary" id = "signup" type="submit" name= "submit" value="Change Password">
        <%
